<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="瘦身效果" prop="shoushenxiaoguo">
          <el-input v-model="ruleForm.shoushenxiaoguo" 
              placeholder="瘦身效果" clearable  :readonly="ro.shoushenxiaoguo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="瘦身效果" prop="shoushenxiaoguo">
              <el-input v-model="ruleForm.shoushenxiaoguo" 
                placeholder="瘦身效果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="器材介绍" prop="qicaijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qicaijieshao" label="器材介绍" prop="qicaijieshao">
                    <span>{{ruleForm.qicaijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
