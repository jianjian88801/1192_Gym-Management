<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="会员卡编号" prop="huiyuankabianhao">
            <el-input v-model="ruleForm.huiyuankabianhao" 
                placeholder="会员卡编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huiyuankabianhao" label="会员卡编号" prop="huiyuankabianhao">
              <el-input v-model="ruleForm.huiyuankabianhao" 
                placeholder="会员卡编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="会员卡名称" prop="huiyuankamingcheng">
          <el-select  @change="huiyuankamingchengChange" v-model="ruleForm.huiyuankamingcheng" placeholder="请选择会员卡名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.huiyuankamingcheng" label="会员卡名称" prop="huiyuankamingcheng">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体测情况" prop="ticeqingkuang">
          <el-input v-model="ruleForm.ticeqingkuang" 
              placeholder="体测情况" clearable  :readonly="ro.ticeqingkuang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体测情况" prop="ticeqingkuang">
              <el-input v-model="ruleForm.ticeqingkuang" 
                placeholder="体测情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
