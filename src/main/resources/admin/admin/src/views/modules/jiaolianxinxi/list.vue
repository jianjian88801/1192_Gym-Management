      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '教练类型' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.jiaolianleixing" placeholder="教练类型" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.jiaolianleixing" placeholder="教练类型" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.jiaolianleixing" placeholder="教练类型" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '教练价格' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.jiaolianjiage" placeholder="教练价格" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.jiaolianjiage" placeholder="教练价格" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.jiaolianjiage" placeholder="教练价格" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '工作履历' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.gongzuolvli" placeholder="工作履历" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.gongzuolvli" placeholder="工作履历" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.gongzuolvli" placeholder="工作履历" clearable></el-input>
                </el-form-item>
          <el-form-item>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('jiaolianxinxi','解聘') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jiepinCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'解聘':'' }}</el-button>
                <el-button v-if="isAuth('jiaolianxinxi','解聘') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jiepinCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'解聘':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('jiaolianxinxi','解聘') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiepinCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'解聘':'' }}</el-button>
