<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="指导教练" prop="zhidaojiaolian">
          <el-select v-model="ruleForm.zhidaojiaolian" placeholder="请选择指导教练">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="指导教练" prop="zhidaojiaolian">
	      <el-input v-model="ruleForm.zhidaojiaolian"
                placeholder="指导教练" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="指导项目" prop="zhidaoxiangmu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhidaoxiangmu" label="指导项目" prop="zhidaoxiangmu">
                    <span>{{ruleForm.zhidaoxiangmu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshishu = true;
          ...
          if(o=='zhidaoxiangmu'){
            this.ruleForm.zhidaoxiangmu = obj[o];
	    this.ro.zhidaoxiangmu = true;
            continue;
          }
          if(o=='zhidaojiaolian'){
            this.ruleForm.zhidaojiaolian = obj[o];
	    this.ro.zhidaojiaolian = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yuangong/yuangongxingming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
